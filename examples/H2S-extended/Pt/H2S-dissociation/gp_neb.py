...
noise_e, noise_f, tag = 0.03, 0.05, 'h2s_RBF'
vasp_args = {"nelm" : 500, 
        "kpts" : [2, 2, 1]
        }
traj = 'gp_neb.traj'
...
for i, image in enumerate(images):
    base_calc = get_vasp(**vasp_args, directory=f"GP/calc_{i}")
...
neb, refs = neb_calc(images, steps=1000, algo='FIRE',
...
plot_path(data, title='H2S on Pt(100)', figname='gp_neb.png')
